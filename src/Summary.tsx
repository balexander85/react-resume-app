      ...
      <div className='summary-text'>
        {summaryList.length > 0 ? (
          ...
          <>
            ...
            <p>Franzen readymade flexitarian ascot unicorn. Pug narwhal voluptate fit venmo polaroid
               aesthetic kombucha mixtape pabst offal church-key tattooed. Wayfarers enim echo park
               yuccie narwhal bespoke kitsch microdosing mollit woke tofu. Quinoa cillum mlkshk semiotics
               kombucha live-edge lomo hammock in jean shorts street art. Tbh trust fund reprehenderit
               gluten-free pug dolore lyft asymmetrical portland voluptate sint hexagon.
               Ennui gatekeep mixtape eu marxism, franzen duis poke sint bespoke XOXO Brooklyn.
               VHS cloud bread +1 kitsch waistcoat.
            </p>
          </>
        )}
      </div>
